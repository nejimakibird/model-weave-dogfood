...
| src/main.ts | ModelWeavePlugin.updateSettings | method | 設定変更の保存とPreview更新 |
| src/main.ts | ModelWeavePlugin.refreshOpenModelWeaveViews | method | 開いているPreviewへViewerPreferencesを再反映 |
