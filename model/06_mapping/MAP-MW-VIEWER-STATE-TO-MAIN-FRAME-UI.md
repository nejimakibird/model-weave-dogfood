...
| lowerPanelTabState | [[SCR-MW-VIEWER-MAIN-FRAME]].lowerPanelTabs | available tabsとactive tabをViewer下部tab UIへ反映 | | N | implemented。renderer switchingやBusiness Flow direction変更後も安定維持 |
