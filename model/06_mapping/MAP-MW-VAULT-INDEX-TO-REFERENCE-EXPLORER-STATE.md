...
|---|---|---|---|---|---|
| [[DATA-MW-REFERENCE-EXPLORER-STATE]].sourceIndexId | [[DATA-MW-VAULT-MODEL-INDEX]] | 表示用IDを派生 |  | N | 実装IndexにindexId fieldはない |
| [[DATA-MW-REFERENCE-EXPLORER-STATE]].referenceCount | [[DATA-MW-VAULT-MODEL-INDEX]].relationsById | relation件数を集計 |  | N | 参照総数の表示用派生値 |
| [[DATA-MW-REFERENCE-EXPLORER-STATE]].unresolvedReferenceCount | [[DATA-MW-VAULT-MODEL-INDEX]].warningsByFilePath | unresolved-reference件数を集計 | [[RULE-MW-RENDERER-DIAGNOSTICS-SEVERITY-MAP]] | N | 未解決参照数の表示用派生値 |
| [[DATA-MW-REFERENCE-EXPLORER-STATE]].visibleReferences | [[DATA-MW-VAULT-MODEL-INDEX]].relationsById | 初期表示では全relationを表示対象にする |  | Y | Explorerはfuture/planned。現行Indexのrelation lookupを元にする |
| [[DATA-MW-REFERENCE-EXPLORER-STATE]].relatedDiagnostics | [[DATA-MW-VAULT-MODEL-INDEX]].warningsByFilePath | 参照に関連する診断だけを抽出 | [[RULE-MW-RENDERER-DIAGNOSTICS-SEVERITY-MAP]] | N | 未解決参照など |
| [[DATA-MW-REFERENCE-EXPLORER-STATE]].selectedReferenceId | [[ENT-MW-MODEL-REFERENCE]].referenceId | 初期状態では空または未選択 |  | N | ユーザー選択後に設定 |
| [[DATA-MW-REFERENCE-EXPLORER-STATE]].selectedSourceAssetId | [[ENT-MW-MODEL-REFERENCE]].sourceAssetId | 選択参照から導出 |  | N | 選択時に設定 |
| [[DATA-MW-REFERENCE-EXPLORER-STATE]].selectedTargetAssetId | [[ENT-MW-MODEL-REFERENCE]].targetAssetId | 選択参照から導出 |  | N | 解決済みの場合 |
...
| [[DATA-MW-REFERENCE-EXPLORER-STATE]].filteredReferenceCount | [[DATA-MW-REFERENCE-EXPLORER-STATE]].visibleReferences | visibleReferencesの件数を計算 |  | N | 初期表示件数 |
| [[DATA-MW-REFERENCE-EXPLORER-STATE]].explorerStatus | [[DATA-MW-REFERENCE-EXPLORER-STATE]].visibleReferences | 件数や診断状態から決定 | [[RULE-MW-RENDERER-DIAGNOSTICS-SEVERITY-MAP]] | N | ready / empty / error |
