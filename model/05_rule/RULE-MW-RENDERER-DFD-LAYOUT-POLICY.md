...
|---|---|---|---|
| source/model-weave-repo/src/renderers/dfd-mermaid.ts | buildDfdMermaidSource | function | DFD Mermaidソース生成の起点 |
| source/model-weave-repo/src/renderers/dfd-mermaid.ts | sanitizeMermaidEdgeLabel | function | ラベルのサニタイズ実装 |
| source/model-weave-repo/src/core/relation-resolver.ts | resolveDfdDiagramRelations | function | 接続関係の解決ロジック |