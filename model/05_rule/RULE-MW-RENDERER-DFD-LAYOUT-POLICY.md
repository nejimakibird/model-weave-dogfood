...
| path | notes |
|---|---|
| src/renderers/dfd-mermaid.ts | symbol: buildDfdMermaidSource; kind: function; DFD Mermaidソース生成の起点 |
| src/renderers/dfd-mermaid.ts | symbol: sanitizeMermaidEdgeLabel; kind: function; ラベルのサニタイズ実装 |
| src/core/relation-resolver.ts | symbol: resolveDfdDiagramRelations; kind: function; 接続関係の解決ロジック |
