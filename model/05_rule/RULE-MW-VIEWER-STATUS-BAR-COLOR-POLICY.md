...
- error / warning がなく info のみの場合、通常またはinfo表示にする。Viewerの診断パネルではinfoをNotesとして表示する。
...
| infoTone | info | infoまたはmanual viewport |
...
| src/styles.css | symbol: mw-preview; kind: css; Viewer表示スタイル |
