...
| flow_diagram | parseFlowDiagramFile | type: flow_diagram。Domain Sources、local Domains、flow_viewを含むFlow Diagramを解析 |
...
| src/parsers/dfd-diagram-parser.ts | Flow Diagram parser with Domain Sources and flow_view |
