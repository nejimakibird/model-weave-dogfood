...
|---|---|---|---|---|
| F01 | MD_FILES | PARSER | Markdown Source | |
| F02 | PARSER | VAULT_INDEX | Internal Model | |
| F03 | PARSER | DIAGNOSTICS | Raw Warnings | |
| F04 | VAULT_INDEX | RENDERER | Model Structure | |
| F05 | RENDERER | VIEWER | Rendered Content | Mermaid SVG / HTML |
| F06 | DIAGNOSTICS | VIEWER | Diagnostic List | Error/Warning/Info |
| F07 | VIEWER | PNG_EXPORT | Rendered Surface | |
