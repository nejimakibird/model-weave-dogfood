...
| 0.1.19 | Flow Diagram MVP, diagnostics guidance, Color Scheme preview editing, Applied Color Scheme compact display | implemented / future | Flow Diagram MVPは [[DATA-MW-FLOW-DIAGRAM-PARSED-DIAGRAM]]、[[PROC-MW-FLOW-DIAGRAM-PARSE]]、[[PROC-MW-FLOW-DIAGRAM-RENDER]]、[[FLOW-MW-VIEWER-DIAGNOSTIC-QUICK-FIX]] に反映済み。MVP外のprojection / folding / coverage生成はfuture |
...
- Flow Diagramの代表サンプルとして [[FLOW-MW-VIEWER-DIAGNOSTIC-QUICK-FIX]] を追加済みである。このサンプルはscreen communicationの流れを示すものであり、DFD、Explorer、projection view、自動生成機能ではない。
