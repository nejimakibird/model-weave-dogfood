...
Model Weave 0.1.17 時点では、app_process Business Flow、Business Flow direction、Domain Sources、color_scheme、Source Links section support、Impact / Relationship View、Weave Map が実装側に進んでいます。AI生成では、実装済みの表示機能と dogfood 先行のExplorer構想を分けて扱ってください。
