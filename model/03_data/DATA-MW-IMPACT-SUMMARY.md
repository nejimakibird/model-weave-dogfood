...
| path | notes |
|---|---|
| src/types/models.ts | symbol: ImpactSummary; kind: interface; impact summaryの本体 |
| src/types/models.ts | symbol: ImpactReference; kind: interface; 参照1件の詳細 |
| src/types/models.ts | symbol: ImpactRelationship; kind: interface; 参照関係のグループ |
| src/types/models.ts | symbol: ImpactValueUsage; kind: interface; codeset member利用 |
| src/types/models.ts | symbol: ImpactSourceLink; kind: interface; 関連Source Links |
| src/core/impact-analyzer.ts | symbol: buildImpactSummary; kind: function; summary生成 |
| src/core/impact-analyzer.ts | symbol: collectRelatedSourceLinks; kind: function; 関連Source Links集約 |
| src/core/impact-analyzer.ts | symbol: formatImpactSummaryAsMarkdown; kind: function; Markdown整形 |
