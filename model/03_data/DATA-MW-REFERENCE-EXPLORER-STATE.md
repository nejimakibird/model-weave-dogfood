...
| source/model-weave-repo/src/core/current-file-diagnostics.ts | buildCurrentObjectDiagnostics | function | 未解決参照などの診断生成 |
| source/model-weave-repo/src/main.ts | openDiagnosticLocation | function | 診断箇所ジャンプの参考 |