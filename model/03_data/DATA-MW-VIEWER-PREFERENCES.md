...
- defaultBusinessFlowDirection / defaultDomainsViewMode / defaultDomainDiagramViewMode は ModelWeaveViewerPreferences に含まれ、Preview内のBusiness Flow方向やDomain表示モードの既定値として使われる。
