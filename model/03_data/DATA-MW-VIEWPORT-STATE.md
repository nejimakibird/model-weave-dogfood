...
| path | notes |
|---|---|
| src/renderers/graph-view-shared.ts | symbol: GraphViewportState; kind: interface; zoom / pan / fit 状態の実装側定義 |
| src/renderers/graph-view-shared.ts | symbol: resetGraphViewportState; kind: function; viewport状態の初期化 |
| src/renderers/graph-view-shared.ts | symbol: attachGraphViewportInteractions; kind: function; zoom / pan 状態の更新 |
| src/views/modeling-preview-view.ts | symbol: CachedViewportState; kind: interface; file単位のviewportキャッシュ |
| src/views/modeling-preview-view.ts | symbol: prepareFileViewportState; kind: method; file切替時のviewport復元 |
| src/views/modeling-preview-view.ts | symbol: rememberViewportState; kind: method; viewport状態のキャッシュ保存 |
