...
## Notes
- 本処理はReference Explorerから参照元または参照先のMarkdownファイルを開くUI操作である。
...
| source/model-weave-repo/src/core/vault-index.ts | VaultIndex | class | ModelAssetとfilePathの参照元 |
| source/model-weave-repo/src/views/modeling-preview-view.ts | renderCurrentState | method | 開いたファイルのViewer表示更新 |