...
| diagnosticsPanel | Diagnostics Panel | panel | review_panel_area |  | N | [[SCR-MW-VIEWER-DIAGNOSTICS-PANEL]] | [[RULE-MW-RENDERER-DIAGNOSTICS-SEVERITY-MAP]] | 診断メッセージ、copy actions、Quick Fix MVPを表示する下部パネル |
