...
| path | notes |
|---|---|
| src/models/core/model-repository.ts | symbol: ModelRepository; kind: class; リポジトリ管理の実装 (未確認) |
| src/models/core/file-parser.ts | symbol: parseModelFile; kind: function; ファイルからアセットへの解析 (未確認) |
